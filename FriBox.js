...
streznik.listen(process.env.PORT, function(){console.log("Streznik je pognan.")});
...
function posredujNapako404(odgovor){
    ...
    odgovor.writeHead("Napaka 404: Vira ni mogoce najti");
    odgovor.end();
...
function posredujNapako500(odgovor){
    ...
    odgovor.writeHead("Napaka 500: Vira ni mogoce najti");
    odgovor.end();
